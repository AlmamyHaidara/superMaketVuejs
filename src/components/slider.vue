	...
	<div id="carouselExampleIndicators" class="carousel slide mt-5">
		...
		<div class="carousel-inner w-100 mx-auto"  >
			<div class="carousel-item active">
				<img :src="require('@/assets/Images/Boisson.jpg')" class="d-block  mx-auto img-fluid w-75  img-responsive c-img" alt="p">
			</div>
			<div class="carousel-item">
				<img :src="require('@/assets/Images/img4.png')" class="d-block  mx-auto img-fluid w-75 c-img" alt="p">
			</div>
			<div class="carousel-item">
				<img :src="require('@/assets/Images/img9.jpg')" class="d-block mx-auto w-75 c-img" alt="p">
			</div>
		</div>
